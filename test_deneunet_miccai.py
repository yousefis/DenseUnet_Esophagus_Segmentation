...
def test_folds(fold,test_vali ,densnet_unet_config,Log,log_tag):
    # '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/Log-28-1-2018/34443_1_4_DenseUnet_esoph_lessFM_04/'
    # log_tag='13331_0.75_4-cross-noRand-train2test2--8/'
    ...
    _dn = _densenet_unet_miccai(densnet_unet_config, compression_coefficient, growth_rate)  # create object
    ...
    # accuracy = tf.reduce_mchckpnt_direan(tf.cast(correct_prediction, tf.float32))
    ...
    copyfile('./test_deneunet_miccai.py',
             '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/' + Log + out_dir + 'test_deneunet_miccai.py')
...
if __name__ == "__main__":
    ...
    # Log = 'Log_2018-08-15/dilated-mid/'
    # Log = 'Log_2018-08-15/cross_validation/'
    # Log = 'Log_2018-08-15/0_CrossValidation_on_both_datasets/'
    # Log = 'Log_2018-08-15/00_Seperate_training_2nddataset/'
    Log = 'Log_2018-08-15/00-miccai_densenet/'
    # densnet_unet_config=[3,4,4,4,3]
    # densnet_unet_config=[2,2,3,2,2]
    is_vali=0
    densnet_unet_config = [3,4,4,4,3]
    for fold in range(1,3):
        log_tag = '34443_0.5_4-cross-noRand-train1-' + str(fold) + '/'
        test_folds(fold=fold,test_vali = is_vali,densnet_unet_config=densnet_unet_config,Log=Log,log_tag=log_tag)