...
def submit_job():
    ...
    setting['cluster_NodeList'] = 'res-hpc-lkeb03'   # None, LKEBgpu: ['res-hpc-lkeb03', 'res-hpc-lkeb02', 'res-hpc-gpu01', 'res-hpc-lkeb05']
    setting['cluster_NumberOfCPU'] = 11 #10 #3               # Number of CPU per job
    ...
    main_script = 'run_attentionnet.py'
    ...
    job_name = 'RF'+ext+'_'+str(backup_number)
...
def backup_script(script_address, main_script, folder_script, net_config):
    ...
    backup_root_folder = script_folder + 'CodeCluster_fold0_attention/RF'+ext+'/'
