...
import scipy.misc
from loss_func import _loss_func
#import math as math
import numpy as np
import os
...
# Log = 'Log_2018-08-15/5foldcrossvalidation/'
...
if __name__ == "__main__":
    ...
    dn_out = _dn.dens_net(image, is_training,dropout_rate1=0,dropout_rate2=0, dim=ct_cube_size, is_training_bn=is_training_bn,seed=0)
    ...
    # copyfile('./test_densenet_unet_crop.py',
    #          '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/' + Log + out_dir + 'test_densenet_unet_crop.py')
