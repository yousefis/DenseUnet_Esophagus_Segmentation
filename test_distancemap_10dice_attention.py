...
# from functions.networks.dense_unet2_attention import _densenet_unet
from functions.networks.dense_unet2_attention_channel_spatial import _densenet_unet #dice+attention channel  no distancemap+spatial
from functions.measurements import _measure
from functions.image_class_penalize import image_class

eps = 1E-5
plot_tag = 'densenet'
densnet_unet_config = [3,3,5,3,3]#,[1, 3, 3, 3, 1]
ct_cube_size = 255
...
def test_all_nets(fold,out_dir,Log):
    ...
    for img_indx in range(len(test_CTs)):
        ...
        [CT_image, GTV_image, Torso_image,Penalize_image,
         volume_depth, voxel_size, origin, direction] = _rd.read_image_seg_penalize_volume(test_CTs,
                                                                                  test_GTVs,
                                                                                  test_Torso,
                                                                                   test_penalize,
                                                                                  img_indx,
        ...
        for _z in (range(int(ct_cube_size / 2) +1, CT_image.shape[0] - int(ct_cube_size / 2)+7, int(ct_cube_size )-int(gap)+1)):
            ...
            for _x in (range(int(ct_cube_size / 2) + 1, CT_image.shape[1] - int(ct_cube_size / 2)+7,int(ct_cube_size )-int(gap)+1)):
                ...
                for _y in (range(int(ct_cube_size / 2) + 1, CT_image.shape[2] - int(ct_cube_size / 2)+7, int(ct_cube_size )-int(gap)+1)):
                    ...
                    penlz = Penalize_image[_z - int(gtv_cube_size / 2) - 1:_z + int(gtv_cube_size / 2),
                          _x - int(gtv_cube_size / 2) - 1:_x + int(gtv_cube_size / 2),
                          _y - int(gtv_cube_size / 2) - 1:_y + int(gtv_cube_size / 2)]
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'f1_bp_tumor.png')

    plt.figure()
    plt.boxplot(f1_bp1, 0, '')
    plt.title('Background Dice value for all the images '+plot_tag)
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'f1_bp_background.png')

    plt.figure()
    plt.boxplot(f1_bp_av, 0, '')
    plt.title('Average Dice value for all the images'+plot_tag)
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'f1_bp_average.png')
    #----------------------
    fpr_bp0 = []
    fpr_bp0.append((fpr0))
    plt.figure()
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fpr_bp_tumor.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fpr_bp_background.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fpr_bp_average.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fnr_bp_tumor.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fnr_bp_background.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fnr_bp_average.png')
    #----------------------
    pres_bp0 = []
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'precision_bp_tumor.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'precision_bp_background.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'precision_bp_average.png')
    #----------------------
    recall_bp0 = []
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'recall_bp_tumor.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'recall_bp_background.png')
    ...
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'recall_bp_average.png')
    #----------------------
    plt.figure()
    d_bp = []
    ...
    plt.grid()
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'dice_bar.png')
    ...
    plt.grid()
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fnr_background_bar.png')
    ...
    plt.grid()
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fnr_tumor_bar.png')
    ...
    plt.grid()
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fpr_background_bar.png')
    ...
    plt.grid()
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'fpr_tumor_bar.png')
    ...
    plt.grid()
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'recall_background_bar.png')
    ...
    plt.grid()
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'recall_tumor_bar.png')
    ...
    plt.grid()
    plt.savefig('/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Log+out_dir+name+'recall_average_bar.png')


if __name__ == "__main__":
    # '/exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/Log-28-1-2018/34443_1_4_DenseUnet_esoph_lessFM_04/'
    ...
    Log = '/Log_2019_09_23/Dataset3/33533_0.75_4-train1-07102020_140/' #dice+attention channel  no distancemap+spatial
