...
def submit_job():
 ...
 #weak: res-hpc-lkeb04
    ...
    main_script = '/run_net_surfacemap_attention_spatial_focal_dice.py'
    ...
    job_name = 'focal'+ext+'_'+str(backup_number)
...
def backup_script(script_address, main_script, folder_script, net_config):
    ...
    backup_root_folder = script_folder + 'CodeCluster_new_data/new'+ext+'_surfacemap_spatial_att_focal_dice2/'
