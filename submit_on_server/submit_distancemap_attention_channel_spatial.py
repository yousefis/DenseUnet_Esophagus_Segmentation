...
def submit_job():
 ...
 #weak: res-hpc-lkeb04
    ...
    main_script = '/run_net_distancemap_attention_channel_spatial.py'
...
def backup_script(script_address, main_script, folder_script, net_config):
    ...
    backup_root_folder = script_folder + 'CodeCluster_new_data/new'+ext+'_attentiondenseblock02_nomap_channel_spatial/'
