...
def submit_job():
 ...
 #weak: res-hpc-lkeb04
    ...
    main_script = '/run_net_sampling.py'
    ...
    job_name = 'sampling'+ext+'_'+str(backup_number)
...
def backup_script(script_address, main_script, folder_script, net_config):
    ...
    backup_root_folder = script_folder + 'CodeCluster_new_data/new'+ext+'sampling-01/'
    print(backup_root_folder)
