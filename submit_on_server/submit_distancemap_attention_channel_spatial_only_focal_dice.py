...
def submit_job():
 ...
 #weak: res-hpc-lkeb04
    ...
    # Slurm
    setting['cluster_MemPerCPU'] = 5600   #2200  # 6200
    ...
    main_script = '/run_net_surfacemap_attention_spatial_only_focal_dice.py'
    ...
    job_name = 'onlyfocal'+ext+'_'+str(backup_number)
...
def backup_script(script_address, main_script, folder_script, net_config):
    ...
    backup_root_folder = script_folder + 'CodeCluster_new_data/new'+ext+'_surfacemap_spatial_att_only_focal_dice/'
