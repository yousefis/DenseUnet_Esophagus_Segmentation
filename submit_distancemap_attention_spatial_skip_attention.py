...
def submit_job():
 ...
 #weak: res-hpc-lkeb04
    ...
    main_script = '/run_net_surfacemap_attention_spatial_skip_attention.py'
    ...
    job_name = 'att_ch_skip'+ext+'_'+str(backup_number)
...
def backup_script(script_address, main_script, folder_script, net_config):
    ...
    backup_root_folder = script_folder + 'CodeCluster_new_data/new'+ext+'_surfacemap_spatial_att_skip_ch_att/'
