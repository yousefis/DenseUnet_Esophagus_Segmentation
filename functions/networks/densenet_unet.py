...
class _densenet_unet:
    ...
    def dens_net(self, image, is_training, dropout_rate1,dropout_rate2, dim,is_training_bn):
        ...
        conv1 = tf.layers.conv3d(inputs=bn1, filters=16, kernel_size=3,
                                 padding='same',
                                 activation=None,
                                 name='conv_deconv_00' + self.log_ext, dilation_rate=(1, 1, 1))
        ...
        conv2 = tf.layers.conv3d(inputs=bn2, filters=16, kernel_size=3,
                                 padding='same',
                                 activation=None,
                                 name='conv_deconv_000' + self.log_ext, dilation_rate=(1, 1, 1))
        ...
        with tf.name_scope('classification_layer'):
            ...
            #                        activation=tf.nn.relu, dilation_rate=(1, 1, 1), name='fc2' + self.log_ext)
            #
        ...
        #h_fc2 = tf.layers.conv3d(h_fc1,512,[3,3],padding="valid", strides=(1,1),activation=tf.nn.relu, dilation_rate=(1, 1))
        h_fc2 = tf.contrib.layers.fully_connected(h_fc1,8,activation_fn=tf.nn.relu)

        #Fully connected layer #3
        #y =  tf.layers.conv3d(h_fc2,2,[3,3],padding="valid", strides=(1,1),activation=tf.nn.relu, dilation_rate=(1, 1))
