...
class dense_seg:
    ...
    def run_net(self):
        ...
        try:
            ...
            copyfile('./run_net_surface_attention_spatial.py', self.LOGDIR + 'run_net_surface_attention_spatial.py')
        ...
        with tf.name_scope('cost'):
            ...
            cost = tf.reduce_mean((- focal_soft_dice[1])+penalize_weight*penalized_loss+surface_loss, name="cost")
