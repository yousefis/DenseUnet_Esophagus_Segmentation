...
class image_class:
    ...
    def read_image(self,img_index,deform,max_dis=0):
        ...
        GTV_image1= self.image_padding(img=GTV_image1,
                           padLowerBound=[int(padding_size/2), int(padding_size/2),int(padding_size/2)],
                           padUpperBound=[int(padding_size/2)+1, int(padding_size/2)+1, int(padding_size/2)+1],
                           constant=0)
        ...
        n = self.node(img_index=img_index, CT_image=CT_image, GTV_image=GTV_image, Torso_image=Torso_image_mul,Penalize_image=[],
    ...
    # --------------------------------------------------------------------------------------------------------
    def read_bunch_of_images_from_both_dataset(self):  # for training
