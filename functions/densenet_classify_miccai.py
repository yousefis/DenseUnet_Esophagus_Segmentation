import time
import os
from functions.densenet_unet_miccai import _densenet_unet_miccai
import numpy as np
...
# --------------------------------------------------------------------------------------------------------
class denseUnet_classify_miccai:
    def __init__(self,data,densnet_unet_config ,compression_coefficient ,growth_rate ,
                 ...
                 tumor_percent,other_percent,Logs,fold):
        settings.init()
        ...
        self.GTV_patchs_size =33#49# 65#33
        self.patch_window = 47#63#73#87#79#57#47
        ...
        self.LOGDIR = '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Logs + self.log_ext + '/'
        self.train_acc_file = '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/Accuracy/' + self.log_ext + '.txt'
        self.train_acc_file = '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/Accuracy/' + self.log_ext + '.txt'
        self.validation_acc_file = '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/Accuracy/' + self.log_ext + '.txt'
        self.chckpnt_dir = '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/'+Logs + self.log_ext + '/densenet_unet_checkpoints/'
        self.out_path = '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/Code/Outputs/' + self.log_ext + '/'
        self.x_hist=0
    ...
    def run_net(self):
        ...
        # _u_net=_unet()
        # _u_net.unet(image)
        _dn = _densenet_unet_miccai(self.densnet_unet_config,self.compression_coefficient,self.growth_rate) #create object
        ...
        sess = tf.Session()
        log_extttt='12521_1_4_all_01'#self.log_ext.split('_')[0]+'01'
        ...
        copyfile('./functions/densenet_unet_miccai.py', self.LOGDIR + 'densenet_unet_miccai.py')
